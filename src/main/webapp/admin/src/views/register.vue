  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.dianhua" autocomplete="off" placeholder="电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiangmufuzeren'" class="input-group">
			   <div class="label">工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gonghao" class="input" type="text" placeholder="工号">
			   </div>
			 </div> -->
			<el-form-item label="工号" class="input" v-if="tableName=='xiangmufuzeren'">
			  <el-input v-model="ruleForm.gonghao" autocomplete="off" placeholder="工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiangmufuzeren'" class="input-group">
			   <div class="label">密码</div>
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xiangmufuzeren'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='xiangmufuzeren'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='xiangmufuzeren'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiangmufuzeren'" class="input-group">
			   <div class="label">电话</div>
			...
			<el-form-item label="电话" class="input" v-if="tableName=='xiangmufuzeren'">
			  <el-input v-model="ruleForm.dianhua" autocomplete="off" placeholder="电话"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.gonghao) && `xiangmufuzeren` == this.tableName){
        this.$message.error(`工号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `xiangmufuzeren` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `xiangmufuzeren` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if(`xiangmufuzeren` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
        this.$message.error(`电话应输入手机格式`);
        return
      }
      this.$http({
